...
#SBATCH --output=logs/lips_67_noLi_%j.out
#SBATCH --error=logs/lips_67_noLi_%j.err
...
echo "  Start     : $(date)"
echo "  System    : 67Li2S-33P2S5, no Li"
echo "  Work Dir  : $(pwd)"
echo "=================================================="
...
log_hardware_info "67Li2S-33P2S5, no Li" "$CONDA_PYTHON" logs
