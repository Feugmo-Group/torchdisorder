...
#SBATCH --output=logs/lips_70_noLi_%j.out
#SBATCH --error=logs/lips_70_noLi_%j.err
...
echo "  Start     : $(date)"
echo "  System    : 70Li2S-30P2S5, no Li"
echo "  Work Dir  : $(pwd)"
echo "=================================================="
...
log_hardware_info "70Li2S-30P2S5, no Li" "$CONDA_PYTHON" logs
