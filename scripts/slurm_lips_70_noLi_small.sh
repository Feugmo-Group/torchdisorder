...
#SBATCH --mem=32G
#SBATCH --time=8:00:00
#SBATCH --output=logs/lips_70_noLi_small_%j.out
#SBATCH --error=logs/lips_70_noLi_small_%j.err
...
echo "  Start     : $(date)"
echo "  System    : 70Li2S-30P2S5, no Li (small)"
echo "  Work Dir  : $(pwd)"
echo "=================================================="
