...
#SBATCH --output=logs/lips_67_withLi_%j.out
#SBATCH --error=logs/lips_67_withLi_%j.err
...
echo "  Start     : $(date)"
echo "  System    : 67Li2S-33P2S5, with Li"
echo "  Work Dir  : $(pwd)"
echo "=================================================="
...
log_hardware_info "67Li2S-33P2S5, with Li" "$CONDA_PYTHON" logs
echo "Starting Training..."

$CONDA_PYTHON scripts/train.py \
    experiment_name=LiPS_67_withLi \
    data=LiPS_67 \
    "data.json_path=$PROJECT_ROOT/data/json/glass_67Li2S_withLi_constraints.json" \
