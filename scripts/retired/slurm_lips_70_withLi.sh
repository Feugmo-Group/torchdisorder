...
#SBATCH --output=logs/lips_70_withLi_%j.out
#SBATCH --error=logs/lips_70_withLi_%j.err
...
echo "  Start     : $(date)"
echo "  System    : 70Li2S-30P2S5, with Li"
echo "  Work Dir  : $(pwd)"
echo "=================================================="
...
log_hardware_info "70Li2S-30P2S5, with Li" "$CONDA_PYTHON" logs
echo "Starting Training..."

$CONDA_PYTHON scripts/train.py \
    experiment_name=LiPS_70_withLi \
    data=LiPS_70 \
    "data.json_path=$PROJECT_ROOT/data/json/glass_70Li2S_withLi_constraints.json" \
