...
class GlassStructureGenerator:
    ...
    # Environment priorities for constraint weighting
    # Higher priority = more strictly enforced
    ENVIRONMENT_PRIORITIES = {
        'P4': 2.0,   # PS4^3- tetrahedral - most important, strict geometry
        'Pa': 1.5,   # P2S7^4- dimer - moderately important
        'P2': 1.5,   # P2S6^4- dumbbell - moderately important
    ...
    def generate_order_parameter_constraints(self, classifications: Dict, stats: Dict) -> Dict:
        ...
        v6 Format:
            - Uses "environment" key (not "environment_type") for EnvironmentConstrainedOptimizer
            - Includes "environment_priorities" section for per-environment weighting
            - Compatible with adaptive penalty coefficients
        
        Returns:
            Dictionary with constraint specifications for each P atom in v6 format
        """
        constraints = {
        ...
        # Collect which environments are actually present
        present_envs = set()
        ...
        constraints['metadata'] = {
            ...
            'notes': 'Constraints for v6 EnvironmentConstrainedOptimizer with adaptive penalties',
            'environment_types': {
